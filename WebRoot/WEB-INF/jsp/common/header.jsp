...
<link rel="Bookmark" href="${pageContext.request.contextPath }/static/icon/HR.ico">
<link rel="Shortcut Icon" href="${pageContext.request.contextPath }/static/icon/HR.ico">
<!--[if lt IE 9]>
...
<body>
	...
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs"
				href="/aboutHui.shtml"><img alt="HR.ico" src="${pageContext.request.contextPath }/static/image/i-HR.png" width="40px"></a> <a
			...
			<ul class="cl">
				<li class="navbar-levelone current"><a href="javascript:;">一般事项</a>
				</li>
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover"><a href="#"
					...
					<ul class="dropDown-menu menu radius box-shadow"
						style="left: -64px">
						<li class=""><a href="javascript:;" onclick="myselfinfo()">个人信息</a>
						</li>
						<li><a href="#">切换账户</a></li>
						<li><a href="#">退出</a></li>
					</ul></li>
	...
	<div class="Hui-aside">
		<div class="menu_dropdown bk_2" style="display: block;">
			...
			<dl id="test">
				<dt>
					<i class="Hui-iconfont">&#xe625;</i> 示例<i
						class="Hui-iconfont menu_dropdown-arrow"></i>
				</dt>
				<dd>
					<ul>
						<li><a
							href="${pageContext.request.contextPath }/sample/sampleList.html">示例列表</a>
						</li>
					</ul>
				</dd>
			</dl>
		...
		<div class="menu_dropdown bk_3" style="display: none">
			<dl id="menu-picture">
				...
				<dd>
					<ul>
						<li><a href="${pageContext.request.contextPath}">组织结构设置</a></li>
						<li><a
							href="${pageContext.request.contextPath}/userlist.html">用户管理</a>
						</li>
						<li><a href="${pageContext.request.contextPath}">职位设置</a></li>
						<li><a href="${pageContext.request.contextPath}">职称设置</a></li>
						<li><a href="${pageContext.request.contextPath}">题库管理设置</a></li>
						<li><a href="${pageContext.request.contextPath}">公共属性设置</a></li>
						<li><a href="${pageContext.request.contextPath}">薪酬项目设置</a></li>
					</ul>
				</dd>
			</dl>
